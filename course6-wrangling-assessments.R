...
## Exercise 1: Which of the following is NOT part of the data wrangling process?
...
## Exercise 2: Which files could be opened in a basic text editor? Select ALL that apply.
...
## Exercise 3: You want to analyze a file containing race finish times for a recent marathon. You open the file in a basic text editor and see lines that look like the following:
...
## Exercise 4: Assume the following is the full path to the directory that a student wants to use as their working directory in R: "/Users/student/Documents/projects/"
## Exercise 4: Which of the following lines of code CANNOT set the working directory to the desired "projects" directory?
...
## Exercise 5: We want to copy the "murders.csv" file from the dslabs package into an existing folder "data",
## Exercise 5: which is located in our HarvardX-Wrangling projects folder. We first enter the code below into our RStudio console.
# getwd() > "C:/Users/UNIVERSITY/Documents/Analyses/HarvardX-Wrangling"
# filename <- "murders.csv"
# path <- system.file("extdata", package = "dslabs")
## Exercise 5: Which of the following commands would NOT successfully copy “murders.csv” into the folder “data”?
...
## Exercise 6: You are not sure whether the murders.csv file has a header row. How could you check this?
## Exercise 6: Select ALL that apply.
...
## Exercise 7: What is one difference between read_excel() and read_xlsx()?
...
## Exercise 8: You have a file called “times.txt” that contains race finish times for a marathon. The first four lines of the file look like this:
# initials,state,age,time
# vib,MA,61,6:01
# adc,TX,45,5:45
# kme,CT,50,4:19
## Exercise 8: Which line of code will NOT produce a tibble with column names “initials”, “state”, “age”, and “time”?
...
# Answer: (b) This code will import the comma-separated values table called “times.txt”, but the base R function read.csv does not produce a tibble. It creates a data frame.

## Exercise 9: You also have access to marathon finish times in the form of an Excel document named “times.xlsx”. In the Excel document, different sheets contain race information for different years.
## Exercise 9: The first sheet is named “2015”, the second is named “2016”, and the third is named “2017”.
## Exercise 9: Which line of code will NOT import the data contained in the “2016” tab of this Excel sheet?
...
## Exercise 10: You have a comma-separated values file that contains the initials, home states, ages, and race finish times for marathon runners.
## Exercise 10: The runners’ initials contain three characters for the runners’ first, middle, and last names (for example, “KME”).
## Exercise 10:You read in the file using the following code.
# race_times <- read.csv(“times.csv”)
## Exercise 10: What is the data type of the initials in the object race_times?
...
## Exercise 11: Which of the following is NOT a real difference between the readr import functions and the base R import functions?
...
## Exercise 12: You read in a file containing runner information and marathon finish times using the following code.
# race_times <- read.csv(“times.csv”, stringsAsFactors = F)
## Exercise 12: What is the class of the object race_times?
# (a) data frame; (b) tibble; (c) matrix; (d) vector
# Answer: (a) The read.csv function generates a data frame containing these data.

## Exercise 13: Select the answer choice that summarizes all of the actions that the following lines of code can perform.
## Exercise 13: Please note that the url below is an example and does not lead to data.
...
## Exercise 14: Inspect the file at the following URL:
# http://mlr.cs.umass.edu/ml/machine-learning-databases/breast-cancer-wisconsin/wdbc.data
## Exercise 14: Which readr function should be used to import this file?
# (a) read_table(); (b)read_csv(); (c) read_csv2(); (d) read_tsv(); (e) None of the above
# Answer: (b) this is a comma-separated value file.

## Exercise 15: Check the documentation for the readr function you chose in the previous question to learn about its arguments.
## Exercise 15: Determine which arguments you need to the file from the previous question:
# url <- "http://mlr.cs.umass.edu/ml/machine-learning-databases/breast-cancer-wisconsin/wdbc.data"
## Exercise 15: Does this file have a header row? Does the readr function you chose need any additional arguments to import the data correctly?
...
## Exercise 16: Inspect the imported data from the previous question.
